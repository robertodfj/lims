...
export class ResultadosAlfabeticosPage {
  ...
  protected readonly crud = new EntityDrawerCrud(this.repository, createEmptyResultadoAlfabetico, (value) => !!value.texto.trim(), {
    field: 'codigo',
    next: () => this.repository.nextCodigo(),
  });
  protected readonly resultados = this.crud.items;
